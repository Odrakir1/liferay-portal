...
/**
 * The persistence utility for the registration track service. This utility wraps <code>com.liferay.pair.registration.service.persistence.impl.RegistrationTrackPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see RegistrationTrackPersistence
 * @generated
 */
public class RegistrationTrackUtil {
	 ...
	 */
	public static void clearCache(RegistrationTrack registrationTrack) {
		getPersistence().clearCache(registrationTrack);
	}
	 ...
	 */
	public static Map<Serializable, RegistrationTrack> fetchByPrimaryKeys(
	 ...
	 */
	public static List<RegistrationTrack> findWithDynamicQuery(
	 ...
	 */
	public static RegistrationTrack update(
		RegistrationTrack registrationTrack) {

		return getPersistence().update(registrationTrack);
	}
	 ...
	 */
	public static RegistrationTrack update(
		RegistrationTrack registrationTrack, ServiceContext serviceContext) {

		return getPersistence().update(registrationTrack, serviceContext);
	}
	 ...
	 */
	public static List<RegistrationTrack> findByGroupId(long groupId) {
	 ...
	 */
	public static List<RegistrationTrack> findByGroupId(
	 ...
	 */
	public static RegistrationTrack findByGroupId_First(
			long groupId,
			OrderByComparator<RegistrationTrack> orderByComparator)
		throws com.liferay.pair.registration.exception.
			NoSuchRegistrationTrackException {
	 ...
	 */
	public static RegistrationTrack fetchByGroupId_First(
	 ...
	 * @throws NoSuchRegistrationTrackException if a matching registration track could not be found
	 */
	public static RegistrationTrack findByGroupId_Last(
			long groupId,
			OrderByComparator<RegistrationTrack> orderByComparator)
		throws com.liferay.pair.registration.exception.
			NoSuchRegistrationTrackException {
	 ...
	 */
	public static RegistrationTrack fetchByGroupId_Last(
		long groupId, OrderByComparator<RegistrationTrack> orderByComparator) {
	 ...
	 */
	public static RegistrationTrack[] findByGroupId_PrevAndNext(
	 ...
	 */
	public static List<RegistrationTrack> filterFindByGroupId(long groupId) {
	 ...
	 */
	public static List<RegistrationTrack> filterFindByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @throws NoSuchRegistrationTrackException if a registration track with the primary key could not be found
	 */
	public static RegistrationTrack[] filterFindByGroupId_PrevAndNext(
			long registrationTrackId, long groupId,
			OrderByComparator<RegistrationTrack> orderByComparator)
		throws com.liferay.pair.registration.exception.
			NoSuchRegistrationTrackException {
	 ...
	 */
	public static void cacheResult(RegistrationTrack registrationTrack) {
		getPersistence().cacheResult(registrationTrack);
	}
	 ...
	 */
	public static void cacheResult(List<RegistrationTrack> registrationTracks) {
		getPersistence().cacheResult(registrationTracks);
	}
	 ...
	 */
	public static RegistrationTrack create(long registrationTrackId) {
		return getPersistence().create(registrationTrackId);
	}
	 ...
	 * @throws NoSuchRegistrationTrackException if a registration track with the primary key could not be found
	 */
	public static RegistrationTrack remove(long registrationTrackId)
		throws com.liferay.pair.registration.exception.
			NoSuchRegistrationTrackException {

		return getPersistence().remove(registrationTrackId);
	}

	public static RegistrationTrack updateImpl(
		RegistrationTrack registrationTrack) {

		return getPersistence().updateImpl(registrationTrack);
	}
	 ...
	 * @throws NoSuchRegistrationTrackException if a registration track with the primary key could not be found
	 */
	public static RegistrationTrack findByPrimaryKey(long registrationTrackId)
		throws com.liferay.pair.registration.exception.
			NoSuchRegistrationTrackException {

		return getPersistence().findByPrimaryKey(registrationTrackId);
	}
	 ...
	 */
	public static RegistrationTrack fetchByPrimaryKey(
		long registrationTrackId) {

		return getPersistence().fetchByPrimaryKey(registrationTrackId);
	}
	 ...
	 */
	public static List<RegistrationTrack> findAll() {
	 ...
	 */
	public static List<RegistrationTrack> findAll(int start, int end) {
	...
	public static RegistrationTrackPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<RegistrationTrackPersistence, RegistrationTrackPersistence>
			_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			RegistrationTrackPersistence.class);

		ServiceTracker
			<RegistrationTrackPersistence, RegistrationTrackPersistence>
				serviceTracker =
					new ServiceTracker
						<RegistrationTrackPersistence,
						 RegistrationTrackPersistence>(
							 bundle.getBundleContext(),
							 RegistrationTrackPersistence.class, null);
